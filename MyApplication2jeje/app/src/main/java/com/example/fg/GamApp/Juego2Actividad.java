...
public class Juego2Actividad extends AppCompatActivity {
    ...
    String resultado;
    Random i = new Random();
    MediaPlayer tijerasound;
    MediaPlayer piedrasound;
    MediaPlayer papelsound;
    MediaPlayer back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back = MediaPlayer.create(Juego2Actividad.this , R.raw.cancion);
        back.setVolume(5,5);
        ...
        tijerasound = MediaPlayer.create(Juego2Actividad.this , R.raw.tijera);
        piedrasound = MediaPlayer.create(Juego2Actividad.this , R.raw.piedra);
        papelsound = MediaPlayer.create(Juego2Actividad.this , R.raw.papel);
